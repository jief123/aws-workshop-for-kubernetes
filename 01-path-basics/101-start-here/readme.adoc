...
The CloudFormation template can create a new VPC. VPC & EC2 Name all equal to Stack Name you input when create Template.
...
a| image::./deploy-to-aws.png[link=https://console.aws.amazon.com/cloudformation/home?region=ap-northeast-1#/stacks/new?stackName=k8s-workshop&templateURL=https://s3-ap-northeast-1.amazonaws.com/cf-templates-ekccenh0a2a7-ap-northeast-1/2018102TRy-YonYouWorkshopdnyddidm4qe]
|===
